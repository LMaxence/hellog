...
3. [Transports and options](#transport-and-options)
   1. [Console](#console)
   2. [File](#file)
4. [Formatters](#formatters)
   1. [Available formatters](#available-formatters)
   2. [Add custom formatters](#custom-formatters)
5. [Extensibility](#extensibility)
   1. [Context elaboration](#context-elaboration)
      1. [Presentation](#presentation)
      2. [Message context elaboration](#improve-context-elaboration)
...
![image](./assets/colorized.png 'Colorized')
...
> Before extending `PreparedMessage` in your formatter declaration, you should read the [Extensibility section](#extensibility)
...
- [Message context elaboration](#improve-context-elaboration)
...
> _This section is about extending the formatting logic. See here for [Custom Formatters](#custom-formatters)_
